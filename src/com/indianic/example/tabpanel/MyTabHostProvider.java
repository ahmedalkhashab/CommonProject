...
import com.indianic.example.ContactActivity;
import com.indianic.example.HomeActivity;
import com.indianic.example.MoreActivity;
import com.indianic.example.R;
import com.indianic.example.ShareActivity;
...
//		shareTab.setSelectedBtnColor(Color.parseColor("#0000FF"));
		...
		shareTab.setIntent(new Intent(context, ShareActivity.class));
